...
class unidirected_edge
{
	...
	public:
		...
		// Inserisco già nel costruttore il fatto che l'arco deve essere ordinato
...
// Definisco l'operatore di stream, l'arco sarà printato come (a,b)
template<typename T>
...
class unidirected_graph
{
	...
	public:
		...
		// Per il metodo all_edges() semplicemente restituisco il mio set archi
		std::set<unidirected_edge<T>> all_edges() const
		{
			return archi;
		}
		
		// Allo stesso modo restituisco il set nodi in all_nodes()
