...
class unidirected_edge
{
	...
	public:
		...
		unidirected_edge()
			: nodo1(T{}), nodo2(T{}), _peso(1)
		{}
		
		// Aggiungo ad ogni arco l'attributo peso (settato di default a valore 1 se non specificato)
		unidirected_edge(const T& n1, const T& n2, int p = 1)
			: _peso(p) 
		{
			if (n1 < n2) {
				nodo1 = n1;
...
class unidirected_graph
{
	...
	public:
		...
		// Aggiungo il metodo print_graph al fine di poter copiare l'output su graphviz
